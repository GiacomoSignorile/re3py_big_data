...
class PipelineOrchestrator:
    ...
    def stage_2_fold_mapping(self) -> bool:
        ...
        for dataset in self.dataset_names:
            ...
            command = [
                sys.executable,
                str(self.base_dir / "fold_mapper.py"),
                "--dataset", dataset
            ]
    ...
    def stage_4_aggregation(self) -> bool:
        ...
        try:
            ...
            with open(combined_csv, 'w') as f:
                # Write header
                f.write("dataset,reduction_%,accuracy_mean,accuracy_std,f1_mean,f1_std,auc_mean,auc_std\n")
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Run full data scarcity experiment pipeline"
    )
